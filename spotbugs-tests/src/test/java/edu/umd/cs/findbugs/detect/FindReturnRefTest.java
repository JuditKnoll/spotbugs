...
class FindReturnRefTest extends AbstractIntegrationTest {
    ...
    void testUnmodifiableClass() {
        performAnalysis("../../spotbugsTestCases/build/classes/java/java17/exposemutable/UnmodifiableClass.class");
        assertNoExposeBug();
    }
    ...
    void testUnmodifiableRecord() {
        performAnalysis("../../spotbugsTestCases/build/classes/java/java17/exposemutable/UnmodifiableRecord.class");
        assertNoExposeBug();
    }
